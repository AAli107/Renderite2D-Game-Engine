...
{
    public partial class QuadSpritesheetRendererProperties : Renderite2D_Game_Engine.RendererComponent_Properties
    {
        [Obsolete("Designer only", true)]
        public QuadSpritesheetRendererProperties()
        {
            InitializeComponent();
        }
        public QuadSpritesheetRendererProperties(LevelEditor levelEditor, string componentId) : base(levelEditor, componentId)
        {
            InitializeComponent();
        }
